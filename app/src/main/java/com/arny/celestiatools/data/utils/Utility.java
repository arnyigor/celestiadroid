package com.arny.celestiatools.data.utils;
...
public class Utility {
	...
	public static boolean empty(@Nullable Object obj ) {
		return KotlinUtilsKt.empty(obj);
	}
		...
		if (data != null) {
			...
			if (bundle != null) {
				...
				for (String key : bundle.keySet()) {
					...
					if (value != null) {
						stringBuilder.append(String.format("%s->%s class(%s)", key, value.toString(), value.getClass().getName()));
					}
				}
